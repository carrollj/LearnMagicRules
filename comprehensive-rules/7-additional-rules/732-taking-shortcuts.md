...
<a id="rule-732-4"></a>
732.4. If a loop contains only mandatory actions, the game is a draw. (See rules [104.4b](../1-game-concepts/104-ending-the-game.md#rule-104-4b) and [104.4f](../1-game-concepts/104-ending-the-game.md#rule-104-4f).)
