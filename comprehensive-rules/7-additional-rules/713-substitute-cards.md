...
<a id="rule-713-3"></a>
713.3. If a substitute card is used in a deck, the card it represents is set aside prior to the beginning of the game (see rule [103.2a](../1-game-concepts/103-starting-the-game.md#rule-103-2a)) and must remain available throughout the game. A substitute card can’t be included in a deck unless it is representing a double-faced card or a meld card.
