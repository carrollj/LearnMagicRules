...
<a id="rule-706-8c"></a>
706.8c If a permanent has an ability that stores results on it and another ability that refers to the stored results, those abilities are linked. (See rule [607.2e](../6-spells-abilities-and-effects/607-linked-abilities.md#rule-607-2e).)
