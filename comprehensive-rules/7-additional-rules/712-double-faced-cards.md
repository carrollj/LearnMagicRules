...
<a id="rule-712-7"></a>
712.7. Players must ensure that double-faced cards in hidden zones are indistinguishable from other cards in the same zone. To do this, the owner of a double-faced card may use completely opaque card sleeves and/or a substitute card (see rule [713](713-substitute-cards.md#rule-713)). Sanctioned tournaments have additional rules for playing with double-faced cards. See rule [100.6](../1-game-concepts/100-general.md#rule-100-6).
...
<a id="rule-712-11"></a>
712.11. A double-faced spell is cast with its front face up by default. See rule [601](../6-spells-abilities-and-effects/601-casting-spells.md#rule-601), “Casting Spells.”
...
<a id="rule-712-12"></a>
712.12. A player playing a modal double-faced card or a copy of a modal double-faced card as a land chooses one of its faces that’s a land before putting it onto the battlefield. It enters the battlefield with that face up. See rule [305](../3-card-types/305-lands.md#rule-305), “Lands.”
...
<a id="rule-712-15"></a>
712.15. If an effect allows a player to cast a double-faced card as a face-down creature spell, or if a double-faced card enters the battlefield face down, it will have the characteristics given to it by the rule or effect that caused it to be face down. That card remains hidden, using a face-down substitute card (see rule [713](713-substitute-cards.md#rule-713)) and/or opaque sleeves. See rule [708](708-face-down-spells-and-permanents.md#rule-708), “Face-Down Spells and Permanents.”
...
<a id="rule-712-17"></a>
712.17. A double-faced card that is exiled face down remains hidden, using a face-down substitute card and/or opaque sleeves. See rule [713](713-substitute-cards.md#rule-713), “Substitute Cards.”
...
<a id="rule-712-21b"></a>
712.21b If a player exiles a melded permanent, that player determines the relative timestamp order of the two cards at that time. This is an exception to the procedure described in rule [613.7m](../6-spells-abilities-and-effects/613-interaction-of-continuous-effects.md#rule-613-7m).
...
<a id="rule-712-21c"></a>
712.21c If an effect can find the new object that a melded permanent becomes as it leaves the battlefield, it finds both cards. (See rule [400.7](../4-zones/400-general.md#rule-400-7).) If that effect causes actions to be taken upon those cards, the same actions are taken upon each of them.
...
<a id="rule-712-21d"></a>
712.21d If multiple replacement effects could be applied to the event of a melded permanent leaving the battlefield or being put into the new zone, applying one of those replacement effects to one of the two cards affects both cards. If the melded permanent is a commander, it may be exempt from this rule; see rules [903.9b](../9-casual-variants/903-commander.md#rule-903-9b)–c.
