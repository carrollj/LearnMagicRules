...
<a id="rule-807-2a"></a>
807.2a Each player has a range of influence of 1 (see rule [801](801-limited-range-of-influence-option.md#rule-801)).

<a id="rule-807-2b"></a>
807.2b The attack left option is used (see rule [803](803-attack-left-and-attack-right-options.md#rule-803)).
...
<a id="rule-807-4f"></a>
807.4f For the purposes of determining if one or more players leaving the game would reduce the number of turn markers in the game (see rule [807.4e](807-grand-melee-variant.md#rule-807-4e)), disregard turn markers already designated for removal.
