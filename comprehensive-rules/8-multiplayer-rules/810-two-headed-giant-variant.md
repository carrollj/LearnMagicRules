...
<a id="rule-810-2"></a>
810.2. The Two-Headed Giant variant uses the shared team turns option. (See rule [805](805-shared-team-turns-option.md#rule-805).)
...
<a id="rule-810-7"></a>
810.7. The Two-Headed Giant variant uses the combat rules for the shared team turns option (see rule [805.10](805-shared-team-turns-option.md#rule-805-10)). This is a change from previous rules.

<a id="rule-810-8"></a>
810.8. The Two-Headed Giant variant uses the normal rules for winning or losing the game (see rule [104](../1-game-concepts/104-ending-the-game.md#rule-104)), with the following additions and specifications.
...
<a id="rule-810-8c"></a>
810.8c If a team’s life total is 0 or less, the team loses the game. (This is a state-based action. See rule [704](../7-additional-rules/704-state-based-actions.md#rule-704).)

<a id="rule-810-8d"></a>
810.8d If a team has fifteen or more poison counters, that team loses the game. (This is a state-based action. See rule [704](../7-additional-rules/704-state-based-actions.md#rule-704).)
