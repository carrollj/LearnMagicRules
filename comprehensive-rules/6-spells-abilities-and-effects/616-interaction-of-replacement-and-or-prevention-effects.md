...
<a id="rule-616-1"></a>
616.1. If two or more replacement and/or prevention effects are attempting to modify the way an event affects an object or player, the affected object’s controller (or its owner if it has no controller) or the affected player chooses one to apply, following the steps listed below. If two or more players have to make these choices at the same time, choices are made in APNAP order (see rule [101.4](../1-game-concepts/101-the-magic-golden-rules.md#rule-101-4)).

<a id="rule-616-1a"></a>
616.1a If any of the replacement and/or prevention effects are self-replacement effects (see rule [614.15](614-replacement-effects.md#rule-614-15)), one of them must be chosen. If not, proceed to rule [616.1b](616-interaction-of-replacement-and-or-prevention-effects.md#rule-616-1b).

<a id="rule-616-1b"></a>
616.1b If any of the replacement and/or prevention effects would modify under whose control an object would enter the battlefield, one of them must be chosen. If not, proceed to rule [616.1c](616-interaction-of-replacement-and-or-prevention-effects.md#rule-616-1c).

<a id="rule-616-1c"></a>
616.1c If any of the replacement and/or prevention effects would cause an object to become a copy of another object as it enters the battlefield, one of them must be chosen. If not, proceed to rule [616.1d](616-interaction-of-replacement-and-or-prevention-effects.md#rule-616-1d).

<a id="rule-616-1d"></a>
616.1d If any of the replacement and/or prevention effects would cause a card to enter the battlefield with its back face up, one of them must be chosen (See rule [701.27](../7-additional-rules/701-keyword-actions.md#rule-701-27), “Transform,” and rule [701.28](../7-additional-rules/701-keyword-actions.md#rule-701-28), “Convert.”). If not, proceed to 616.1e.
