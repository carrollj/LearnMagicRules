...
<a id="rule-612-7"></a>
612.7. One card (Spy Kit) states that an object has “all names of nonlegendary creature cards.” This changes the text that represents the object’s name. That object has the name of each nonlegendary creature card in the Oracle card reference. (See rule [108.1](../1-game-concepts/108-cards.md#rule-108-1).)
...
<a id="rule-612-9"></a>
612.9. A name sticker on a permanent or on a card not on the battlefield creates a continuous effect that adds a word to the text that represents the object’s name. (See rule [123.6](../1-game-concepts/123-stickers.md#rule-123-6).)

<a id="rule-612-10"></a>
612.10. A splice ability changes a spell’s text by adding the rules text of the card with splice to the spell, following that spell’s own rules text. It doesn’t modify or replace any of that spell’s own text. (See rule [702.47](../7-additional-rules/702-keyword-abilities.md#rule-702-47), “Splice.”)
