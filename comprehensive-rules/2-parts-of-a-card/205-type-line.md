...
<a id="rule-205-2a"></a>
205.2a The card types are artifact, battle, conspiracy, creature, dungeon, enchantment, instant, kindred, land, phenomenon, plane, planeswalker, scheme, sorcery, and vanguard. See section [3](../3-card-types/README.md), “Card Types.”
...
<a id="rule-205-3f"></a>
205.3f Many cards were printed with subtypes that are now obsolete. Many cards have retroactively received subtypes. Use the Oracle card reference to determine what a card’s subtypes are. (See rule [108.1](../1-game-concepts/108-cards.md#rule-108-1).)

<a id="rule-205-3g"></a>
205.3g Artifacts have their own unique set of subtypes; these subtypes are called artifact types. The artifact types are Attraction (see rule [717](../7-additional-rules/717-attraction-cards.md#rule-717)), Blood, Bobblehead, Book, Clue, Contraption, Equipment (see rule [301.5](../3-card-types/301-artifacts.md#rule-301-5)), Food, Fortification (see rule [301.6](../3-card-types/301-artifacts.md#rule-301-6)), Gold, Incubator, Infinity, Junk, Lander, Map, Mutagen, Powerstone, Spacecraft, Stone, Treasure, Vehicle (see rule [301.7](../3-card-types/301-artifacts.md#rule-301-7)), and Vibranium.

<a id="rule-205-3h"></a>
205.3h Enchantments have their own unique set of subtypes; these subtypes are called enchantment types. The enchantment types are Aura (see rule [303.4](../3-card-types/303-enchantments.md#rule-303-4)), Background, Cartouche, Case (see rule [719](../7-additional-rules/719-case-cards.md#rule-719)), Class (see rule [716](../7-additional-rules/716-class-cards.md#rule-716)), Curse, Plan, Role (see rule [303.7](../3-card-types/303-enchantments.md#rule-303-7)), Room, Rune, Saga (see rule [714](../7-additional-rules/714-saga-cards.md#rule-714)), Shard, and Shrine.

<a id="rule-205-3i"></a>
205.3i Lands have their own unique set of subtypes; these subtypes are called land types. The land types are Cave, Desert, Forest, Gate, Island, Lair, Locus, Mine, Mountain, Plains, Planet, Power-Plant, Sphere, Swamp, Tower, Town, and Urza’s. Of that list, Forest, Island, Mountain, Plains, and Swamp are the basic land types. See rule [305.6](../3-card-types/305-lands.md#rule-305-6).
...
<a id="rule-205-4d"></a>
205.4d Any permanent with the supertype “legendary” is subject to the state-based action for legendary permanents, also called the “legend rule” (see rule [704.5j](../7-additional-rules/704-state-based-actions.md#rule-704-5j)).
...
<a id="rule-205-4f"></a>
205.4f Any permanent with the supertype “world” is subject to the state-based action for world permanents, also called the “world rule” (see rule [704.5k](../7-additional-rules/704-state-based-actions.md#rule-704-5k)).
...
<a id="rule-205-4h"></a>
205.4h Any scheme card with the supertype “ongoing” is exempt from the state-based action for schemes (see rule [704.6e](../7-additional-rules/704-state-based-actions.md#rule-704-6e)).
