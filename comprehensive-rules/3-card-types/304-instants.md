...
<a id="rule-304-1"></a>
304.1. A player who has priority may cast an instant card from their hand. Casting an instant as a spell uses the stack. (See rule [601](../6-spells-abilities-and-effects/601-casting-spells.md#rule-601), “Casting Spells.”)
...
<a id="rule-304-3"></a>
304.3. Instant subtypes are always a single word and are listed after a long dash: “Instant — Arcane.” Each word after the dash is a separate subtype. The set of instant subtypes is the same as the set of sorcery subtypes; these subtypes are called spell types. Instants may have multiple subtypes. See rule [205.3k](../2-parts-of-a-card/205-type-line.md#rule-205-3k) for the complete list of spell types.
