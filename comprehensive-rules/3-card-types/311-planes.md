...
<a id="rule-311-1"></a>
311.1. Plane is a card type seen only on nontraditional Magic cards. Only the Planechase casual variant uses plane cards. See rule [901](../9-casual-variants/901-planechase.md#rule-901), “Planechase.”
...
<a id="rule-311-3"></a>
311.3. Plane subtypes are listed after a long dash, and may be multiple words: “Plane — Serra’s Realm.” All words after the dash are, collectively, a single subtype. Planar subtypes are called planar types. A plane can have only one subtype. See rule [205.3n](../2-parts-of-a-card/205-type-line.md#rule-205-3n) for the complete list of planar types.
